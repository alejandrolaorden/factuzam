...
type
  ...
  procedure ShowMtoFormasdePago(Owner       : TComponent; sOdon: String); overload;
const
...
var
  frmMtoFormasdePago : TfrmMtoFormasdePago;
begin
  frmMtoFormasdePago := TfrmMtoFormasdePago(FindMDIChildOpen((Owner as TfrmOpenApp),
                                                     TfrmMtoFormasdePago,
                                                     'frmMtoFormasdePago'));
  if (frmMtoFormasdePago = nil) then
  begin
    frmMtoFormasdePago := TfrmMtoFormasdePago.Create(Owner);
    frmMtoFormasdePago.edtBusqGlobal.SetFocus;
  end
  else
    frmMtoFormasdePago.BringToFront;
end;
...
var
  frmMtoFormasdePago : TfrmMtoFormasdePago;
begin
  frmMtoFormasdePago := TfrmMtoFormasdePago(FindMDIChildOpen(
                                                     (Owner as TfrmOpenApp),
                                                     TfrmMtoFormasdePago,
                                                     'frmMtoFormasdePago'));
  if (frmMtoFormasdePago = nil) then
  begin
    ...
    frmMtoFormasdePago.BringToFront;
  if not (frmMtoFormasdePago.tdmDataModule.unqryTablaG.Locate(pkFieldName,
                                                           sOdon, [])) then
    ShowMessage('Forma de pago no encontrada')
  else
     frmMtoFormasdePago.pcPantalla.ActivePage := frmMtoFormasdePago.tsFicha;
